...
<div class="container" style="text-align: center; background-color: #616161;" id="products">
    ...
    <!-- Product Sort Box -->
    <div style="position: sticky; right: 85vw; display: inline-block; padding-top: 20px; height: 60px;">
        <form id="sortForm" method="post" style="text-align: left; display: inline">
    ...
    <!-- Product Filter Box -->
    <div class="filter-dropdown" style="position: sticky; left: 75vw; display: inline-block; padding-top :20px; height:60px;">
    ...
    <p style="padding: 20px; color: white;">Choose a best Product that fits your needs.</p>
    <div style="margin-top: 64px; padding: 0 8px;">
    <?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (isset($_POST["clearFilter"])) {
            // Set a session variable to indicate the filter has been cleared
        ...
        if (isset($_POST['sortOption'])) {
            ...
            unset($_SESSION['selectedOptions']);
            unset($_SESSION['clearFilter']);
        }
    }

    // Use session variables in your query construction...
    if (isset($_SESSION['selectedOptions']) && is_array($_SESSION['selectedOptions'])) {
        ...
        $sql = "SELECT * FROM product_details WHERE $conditionString";

        // Unset the session variable after using it
        unset($_SESSION['selectedOptions']);
    } elseif (isset($_SESSION['clearFilter'])) {
